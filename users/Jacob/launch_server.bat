...
SET mypath=%~dp0
C:\Users\jcsimon\miniconda3\envs\brukerbridge\python.exe %mypath:~0,-13%\brukerbridge\ripping_PC\jacob_server.py >> C:\Users\jcsimon\Documents\Stanford\brukerbridge\logs\server_log.txt 2>&1
cmd /k