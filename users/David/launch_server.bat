...
SET mypath=%~dp0
C:\Users\David\.conda\envs\env_brukerbridge\python.exe %mypath:~0,-13%\brukerbridge\ripping_PC\david_server.py >> C:\Users\David\Desktop\brukerbridge_datalogs\server_log.txt 2>&1
cmd /k