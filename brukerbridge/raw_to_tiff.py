...
def convert_raw_to_tiff(full_target, PVScan_version):
	...
	path_to_ripper_bat = pathlib.Path(parent_path, 'ripper.bat')
	#os.system("C:/Users/User/projects/brukerbridge/scripts/ripper.bat {}".format('"' + full_target + '"'))
	os.system(str(path_to_ripper_bat) + " {}".format('"' + str(full_target) + '"' + ' ' + '"' + str(PVScan_version) + '"'))
